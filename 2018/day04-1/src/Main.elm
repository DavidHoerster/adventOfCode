...
buildGuardLogHelper act stat currLog currMinLog remainingActs =
    case act of
        ...
        WakesUp l ->
            let
                minutes =
                    Maybe.withDefault 0 (Dict.get stat.guard currLog)

                updatedMinutes =
                    minutes + (l.minute - stat.start)
...
view model =
    div []
        ...
        , h1 [] [ text ("Answer is guard " ++ Tuple.first model ++ " " ++ String.fromInt (Tuple.second model)) ]
        ]
