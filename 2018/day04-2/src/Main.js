...
var author$project$Main$getSleepiestMinute = F2(
	function (guardInfo, currMax) {
		var guardCount = guardInfo.b.b;
		var currCount = currMax.b.b;
		return (_Utils_cmp(guardCount, currCount) > 0) ? guardInfo : currMax;
	});
...
var author$project$Main$getSleepiestMinutePerGuard = F3(
	function (guard, minuteList, guardMinuteListAccum) {
		var minuteGroups = elm_community$list_extra$List$Extra$gatherEquals(minuteList);
		var sleepiestMinute = A3(
			...
			minuteGroups);
		return _Utils_ap(
			guardMinuteListAccum,
			_List_fromArray(
				[
					_Utils_Tuple2(guard, sleepiestMinute)
				]));
	});
...
var author$project$Main$init = function () {
	...
	var minuteLog = logs.b;
	var sleepiestMinutePerGuards = A3(elm$core$Dict$foldl, author$project$Main$getSleepiestMinutePerGuard, _List_Nil, minuteLog);
	var sleepyGuard = A3(
		elm$core$List$foldl,
		author$project$Main$getSleepiestMinute,
		_Utils_Tuple2(
			'N/A',
			_Utils_Tuple2(0, 0)),
		sleepiestMinutePerGuards);
	var minute = sleepyGuard.b.a;
	var guardId = sleepyGuard.a;
	return _Utils_Tuple2(
		_Utils_Tuple2(guardId, minute),
